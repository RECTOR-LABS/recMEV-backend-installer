...
- `recmev-backend-v0.1.12-mac`: macOS binary
- `recmev-backend-v0.1.12-linux`: Linux binary
...
curl -fsSL https://raw.githubusercontent.com/RECTOR-LABS/recMEV-backend-installer/main/recmev-backend-v0.1.12-OS -o recmev-backend
...
- v0.1.12 (latest) - Improved cross-compilation and development workflow with enhanced build system and platform detection
