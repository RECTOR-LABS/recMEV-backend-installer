...
- `recmev-backend-v0.1.29-mac`: macOS binary
- `recmev-backend-v0.1.29-linux`: Linux binary
...
curl -fsSL https://raw.githubusercontent.com/RECTOR-LABS/recMEV-backend-installer/main/recmev-backend-v0.1.29-OS -o recmev-backend
...
- v0.1.29 (latest) - Advanced pool type filtering system, pagination control for testing, Meteora Multi-Token Stable pool support, and enhanced configuration migration
