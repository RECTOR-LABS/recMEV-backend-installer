...
- `recmev-backend-v0.1.9-mac`: macOS binary
- `recmev-backend-v0.1.9-linux`: Linux binary
...
curl -fsSL https://raw.githubusercontent.com/RECTOR-LABS/recMEV-backend-installer/main/recmev-backend-v0.1.9-OS -o recmev-backend
...
- v0.1.9 (latest) - Comprehensive help documentation improvements with detailed troubleshooting guides and enhanced user experience
